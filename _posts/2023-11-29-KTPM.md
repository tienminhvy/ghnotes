...
<li><a href="#xét-biến-k-2">Xét biến $k</a></li>
<li><a href="#xét-biến-v-2">Xét biến $v</a></li>
</ul>
</li>
</ul>
</li>
...
Xác định các biến: $gateAbility, $k, $v

Xét biến $gateAbility:
- Tập def của $gateAbility: {1}
- Tập use của $gateAbility: {2,3,5}
